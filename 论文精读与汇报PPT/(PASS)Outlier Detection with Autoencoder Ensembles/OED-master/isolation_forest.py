...
def RunModel(_file_name, _choice, _estimators=100, _contamination=0.1):
    if _choice == 1:
    ...
    np.savetxt('./saved_result/' + pathlib.Path(_file_name).parts[0] + '/if_' + os.path.basename(_file_name) + '_score.txt', score_pred_label, delimiter=',')
